...
<div id="main">
<section id="content">
<header class="archive-header"><h2>搜索：<?php $this->archiveTitle('','',''); ?></h2></header>
...
<?php while($this->next()): ?>
    ...
    <article class="post">
       <header><h2 class="post-title"><a href="<?php $this->permalink() ?>" title="查看《<?php $this->title() ?>》的全文" rel="bookmark"><?php $this->title() ?></a></h2></header>
		...
		<span class="post-comment flr"><a href="<?php $this->permalink() ?>#comments"><?php $this->commentsNum('无回应', '1 回应', '%d 回应'); ?></a></span>
		<div class="clear"></div>
		</footer>
    </article>
